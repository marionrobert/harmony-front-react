...
L’administrateur a un rôle de modérateur : il peut valider ou non la publication des annonces et commentaires créés par les utilisateurs
...
*** Exemple de responsive design sur la page de rpésentation d'une activité
<img src="/public/screenshots/activityDetails.png" alt="screenshot présentation d'une activité en format mobile" width="200">
<img src="/public/screenshots/activityDetailsTabletAndComputer.png" alt="screenshot présentation d'une activité en format tablette et ordinateur" width="800">
<br/>
